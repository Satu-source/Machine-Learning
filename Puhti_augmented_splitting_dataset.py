...
# === CSC Puhti PATHS ===
INPUT_PATH = "/projappl/project_2014146/Satu_honka/processed_food_data"
OUTPUT_PATH = "/projappl/project_2014146/Satu_honka/augmented_split_dataset"
...
def augment_image(img_path, output_dir, class_name):
    ...
    for aug_img, fname in augmented_images:
        save_path = os.path.join(output_dir, class_name, fname)
...
if __name__ == "__main__":
    ...
    # Process healthy and unhealthy classes in parallel
    with Pool(2) as pool:
